    ...
    <section>
        ...
        <div class="WelcomeContentArea">
            ...
            <div class="ButtonIContributor">
                ...
                <input type="button" id="ButtonIContributor" value="СОТРУДНИК" onclick="CheckedIContributor()" />
            </div>
            <div class="ButtonIManager">
                <div id="IManager" class="IManager">
                    <p id="IManagerText" class="IManagerText">Я - </p>
                </div>
                <input type="button" id="ButtonIManager" value="РУКОВОДИТЕЛЬ" onclick="CheckedIManager()" />                
            </div>            
        </div>
